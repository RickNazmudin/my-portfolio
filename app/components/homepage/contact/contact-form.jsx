...
function ContactForm() {
  ...
  return (
    <div>
      <p className="font-medium mb-5 text-[#f9d049] text-xl uppercase">
        Contact with me
      </p>
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#f9d049] ring-0 outline-0 transition-all duration-300 px-3 py-2"
              type="text"
              maxLength="100"
              required={true}
              onChange={(e) =>
